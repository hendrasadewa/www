...
>
	...
	<a href={url}>
		<img
			alt={headerImageAlt}
			src={headerImageURL}
			class="max-h-60 max-w-60 rotate-6 cursor-pointer rounded-lg shadow-md transition-all hover:-translate-x-2 hover:-translate-y-2 hover:shadow-2xl md:h-64 md:w-64"
		/>
	</a>
</article>
